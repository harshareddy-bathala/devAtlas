...
export function Skeleton({ className = '', style }: SkeletonProps) {
  return (
    <div className={`bg-dark-600 rounded animate-pulse ${className}`} style={style} />
  );
}
...
// Chart skeleton
export function ChartSkeleton({ height = 256 }: ChartSkeletonProps) {
  return (
...
export function OverlayLoader({ message }: OverlayLoaderProps) {
  return (
