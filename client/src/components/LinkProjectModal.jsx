...
import { X, Loader2, Link as LinkIcon, Check, Plus, FolderKanban, AlertCircle } from 'lucide-react';
import toast from 'react-hot-toast';
import api from '../utils/api';

function LinkProjectModal({ isOpen, onClose, skill, onLinked }) {
  ...
  const hasCompletedLinked = selectedProjects.some(id => 
